...
const allProducts = [
  ...
  { id: '5', slug: 'microsoft-office-365-na-1-god', name: 'Office 365 Pro Plus for 1 year', image: 'https://rusoft.shop/wp-content/uploads/2026/03/microsoft-365-2022-logo-7b23759a49-seeklogo.com_-150x150-1.png', imageAlt: 'Office 365', rating: 4.99, reviewCount: 179, price: 1790, originalPrice: 2190, category: 'office' },
      ...
      <div className="max-w-7xl mx-auto px-4 pb-12">
        ...
        <div className="bg-white rounded-2xl shadow-sm p-4 mb-6 flex flex-col sm:flex-row gap-4 items-center">
          ...
          <div className="relative w-full sm:w-64">
            ...
            <input type="text" value={searchQuery} onChange={(e) => setSearchQuery(e.target.value)} placeholder="Search products..." className="w-full pl-9 pr-4 py-2 border border-gray-200 rounded-xl text-sm text-gray-700 focus:outline-none focus:border-[#1c64ff]" />
          </div>
        </div>
