...
const categories = [
{
  ...
  href: '/catalog/office',
  image: 'https://rusoft.shop/wp-content/uploads/2025/04/microsoft-office-logo-8b0ef31e09-seeklogo.com-1.svg',
  alt: 'Microsoft Office logo',
  subtitle: 'Office packages',
  subcategories: ['Microsoft 365', 'Microsoft Office 2021', 'Microsoft Office 2019', 'And others']
},
{
  name: 'Microsoft Windows',
  href: '/catalog/windows',
  image: 'https://rusoft.shop/wp-content/uploads/2025/04/logowin11.svg',
  alt: 'Microsoft Windows logo',
  subtitle: 'Operating systems',
  subcategories: ['Windows 11', 'Windows 10', 'Windows 8', 'Windows 7', 'Windows Server', 'And others']
},
{
  name: 'Antivirus',
  href: '/catalog/antivirus',
  image: 'https://rusoft.shop/wp-content/uploads/2025/04/windows-copilot-1.svg',
  alt: 'Antivirus logo',
  subtitle: 'Antivirus protection',
  subcategories: ['Kaspersky', 'ESET', 'Dr. Web', 'And others']
},
{
  name: 'Autodesk',
  href: '/catalog/autodesk',
  image: 'https://rusoft.shop/wp-content/uploads/2024/02/0e6d1d244bf344b638b90c2d675cdc8e-e1708184574767.png',
  alt: 'Autodesk logo',
  subtitle: 'Industrial software',
  subcategories: ['Autodesk All Apps', '3ds Max', 'AutoCAD', 'Civil 3D', 'Revit', 'And others']
},
{
  name: 'Sets',
  href: '/catalog/sets',
  image: 'https://rusoft.shop/wp-content/uploads/2025/04/vector1.svg',
  alt: 'Sets logo',
  subtitle: 'Together cheaper',
  subcategories: ['Windows 11 Pro + Office 2021', 'Windows 11 Home + Office 2021', 'And others']
},
{
  name: 'Subscriptions',
  href: '/catalog/subscriptions',
  image: 'https://rusoft.shop/wp-content/uploads/2025/04/group-5.svg',
  alt: 'Subscriptions logo',
  subtitle: 'Digital services',
  subcategories: ['Adobe', 'Autodesk', 'Acrobat', 'LitRes', 'Yandex Plus', 'And others']
}];
...
const blogPosts = [
{
  title: 'How to set up passwordless login in Windows 11',
  date: 'May 12, 2026',
  category: 'Blog',
  views: 2,
  image: 'https://rusoft.shop/wp-content/uploads/2026/03/i-1-1-150x150-1.png',
  imageAlt: 'How to set up passwordless login in Windows 11 article thumbnail',
  href: '/blog/passwordless-windows-11'
},
{
  title: 'Automatic deletion of temporary files in Windows 11',
  date: 'May 11, 2026',
  category: 'Blog',
  views: 1,
  image: 'https://rusoft.shop/wp-content/uploads/2026/03/i-1-1-150x150-1.png',
  imageAlt: 'Automatic deletion of temporary files in Windows 11 article thumbnail',
  href: '/blog/auto-delete-temp-files'
}];
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
          ...
          <div key={cat.name} className="bg-white rounded-2xl shadow-sm border border-gray-100 p-5 hover:shadow-md transition-shadow">
              <div className="flex items-start gap-4 mb-3">
                <Link href={cat.href} className="flex-shrink-0">
                  <div className="w-14 h-14 rounded-xl bg-gray-50 flex items-center justify-center overflow-hidden">
                    <Image src={cat.image} alt={cat.alt} width={48} height={48} className="w-12 h-12 object-contain" />
                  </div>
                </Link>
                <div className="flex-1">
                  <Link href={cat.href} className="font-bold text-gray-900 hover:text-[#1c64ff] transition-colors block">
                    {cat.name}
                  </Link>
              ...
              <Link
                ...
                sub === 'And others' ? 'text-gray-400' : 'text-[#1c64ff] hover:bg-blue-50'}`
                }>
      ...
      <section className="max-w-7xl mx-auto px-4 py-6">
        <div className="bg-white rounded-2xl shadow-sm p-8 flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <div className="flex-shrink-0">
            <Image
              src="https://rusoft.shop/wp-content/uploads/2024/11/consultation.svg"
      ...
      <section className="max-w-7xl mx-auto px-4 py-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          <Link key={post.title} href={post.href} className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden hover:shadow-md transition-shadow">
              ...
              <div className="p-4">
                <p className="text-xs text-gray-400 mb-2">{post.date} • {post.category} • {post.views} views</p>
          ...
          <Link href="/blog" className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden hover:shadow-md transition-shadow flex flex-col items-center justify-center p-8 text-center">
            <div className="w-12 h-12 bg-gray-100 rounded-full flex items-center justify-center mb-3">
              <Image src="https://rusoft.shop/wp-content/uploads/2024/11/blog.svg" alt="Blog" width={24} height={24} className="w-6 h-6" />
            </div>
      ...
      <section className="max-w-7xl mx-auto px-4 py-6">
        <div className="bg-white rounded-2xl shadow-sm p-8">
          ...
          <div className="text-gray-600 text-sm leading-relaxed space-y-3">
            <p>
              rusoft.shop is an online store of electronic keys for digital products. In our store you can purchase electronic keys for operating systems, office application packages, and antivirus programs. Our customers receive fast and high-quality service, free warranty and lifetime customer support.
            </p>
