...
export default function Header() {
  ...
  { name: 'Microsoft Office', href: '/catalog' },
  { name: 'Microsoft Windows', href: '/catalog' },
  { name: 'Autodesk', href: '/catalog' },
  { name: 'Adobe', href: '/catalog' },
  { name: 'Antivirus', href: '/catalog' },
  { name: 'Sets', href: '/catalog' },
  { name: 'Subscriptions', href: '/catalog' },
  { name: 'Sale', href: '/catalog' }];
    ...
    <>
      ...
      <div className="bg-[#1d1b20] text-white text-sm py-2 px-4 flex items-center justify-between">
        <div className="flex items-center gap-2">
          <Image
            src="https://rusoft.shop/wp-content/uploads/2025/03/banner-left-r7.png"
            alt="R7 Office"
            width={80}
            height={20}
        ...
        <div className="flex items-center gap-2">
          <Image
            src="https://rusoft.shop/wp-content/uploads/2025/03/rusoft_r7.svg"
            alt="R7 Office logo"
            width={60}
            height={16}
