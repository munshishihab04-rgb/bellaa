        ...
        <div className="border-t border-gray-100 pt-8 flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
          ...
          <div className="flex items-center gap-4">
            <a href="https://www.reg.ru/" target="_blank" rel="noopener noreferrer">
              <Image src="https://rusoft.shop/wp-content/uploads/2024/11/footer_logo1-1.svg" alt="REG.RU" width={60} height={24} className="h-6 w-auto opacity-60 hover:opacity-100 transition-opacity" />
            </a>
            <a href="https://www.cloudflare.com/" target="_blank" rel="noopener noreferrer">
              <Image src="https://rusoft.shop/wp-content/uploads/2024/11/footer_logo2-1.svg" alt="Cloudflare" width={60} height={24} className="h-6 w-auto opacity-60 hover:opacity-100 transition-opacity" />
            </a>
            <a href="https://yookassa.ru/" target="_blank" rel="noopener noreferrer">
              <Image src="https://rusoft.shop/wp-content/uploads/2024/11/footer_logo3-1.svg" alt="YooKassa" width={60} height={24} className="h-6 w-auto opacity-60 hover:opacity-100 transition-opacity" />
            </a>
          </div>
        </div>
        ...
        <div className="border-t border-gray-100 pt-4 mt-4 flex flex-col md:flex-row items-center justify-between gap-2">
          ...
          <div className="flex items-center gap-4 flex-wrap">
            ...
            <button className="flex items-center gap-1 text-xs text-gray-400 hover:text-gray-600">
              <Image src="https://rusoft.shop/wp-content/uploads/2024/11/cookies.svg" alt="Cookies" width={16} height={16} className="w-4 h-4" />
              Cookies
            </button>
          </div>
        </div>
